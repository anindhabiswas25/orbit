...
const navLinks = [
  ...
  { name: 'Earnings', href: '/developers/earnings' },
  { name: 'Reputation', href: '/developers/reputation' },
  { name: 'Activity', href: '/developers/activity' },
  { name: 'Build', href: '/developers/build' },
]

/**
 * Developer-portal navbar — visually identical to the landing <Navigation/> and
 * the depositor <AppNav/>: a scroll-aware floating bar that starts transparent
 * (white text) and collapses into a rounded glass pill once scrolled. Links are
 * the portal routes; the right-hand CTA is the Connect / Disconnect wallet pill.
 */
export function DevNav() {
  ...
  const isActive = (href: string) =>
    href === '/developers' ? pathname === href : pathname?.startsWith(href)
