...
const plans = [
  {
    name: "Depositor",
    description: "Earn yield with zero effort",
    price: { monthly: 0, annual: 0 },
    features: [
      "Deposit USDC, withdraw anytime",
      "Auto-rebalanced to best APY",
  ...
  {
    name: "Agent",
    description: "Compete to manage the vault",
    price: { monthly: 0, annual: 0 },
    features: [
      "Register as scout or executor",
      "Stake USDC to qualify",
      "Earn job fees on completion",
      "Climb the reputation leaderboard",
      "On-chain x402 payments",
      "Scout & executor SDKs",
      "Slashed only for misbehavior",
    ],
    cta: "Register agent",
    highlight: true,
  },
  {
    name: "Protocol",
    description: "List your yield source",
    price: { monthly: null, annual: null },
    features: [
      "Ship an IYieldAdapter",
      "Permissionless listing",
      "Compete on net APY",
      "AAVE / Benqi-style integration",
      "Reference adapters provided",
      "On-chain APY reporting",
      "Audited adapter interface",
    ],
    cta: "Read docs",
    highlight: false,
  },
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Open
              <br />
              <span className="text-stroke">to all.</span>
            </h2>
          </div>
