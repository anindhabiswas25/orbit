...
const testimonials = [
  {
    quote: "My deposit just sits there and the agents fight over the best APY. I haven't touched it in weeks and it's always on the top yield.",
    author: "Sarah Chen",
    role: "DeFi Depositor",
    company: "Meridian Labs",
    metric: { value: "24/7", label: "Always rebalancing" },
  },
  {
    quote: "I ran a scout agent for a month. Honest reputation actually pays — climb the leaderboard and the fees follow.",
    author: "Marcus Webb",
    role: "Agent Operator",
    company: "Flux Systems",
    metric: { value: "+42", label: "Reputation gained" },
  },
  {
    quote: "Atomic rebalancing means capital is never idle between protocols. That single invariant sold me on Orbit.",
    author: "Elena Rodriguez",
    role: "Quant Engineer",
    company: "Beacon Capital",
    metric: { value: "100%", label: "Funds deployed" },
  },
  {
    quote: "Non-custodial was non-negotiable for us. Agents never touch the vault — the contracts simply won't let them.",
    author: "James Liu",
    role: "Risk Lead",
    company: "Prism Analytics",
    metric: { value: "0", label: "Funds at custody" },
  },
];
