...
// Entry point into the app (the user's dashboard area).
const APP_HREF = "/deposit";
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>ORBIT</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              <Link href={APP_HREF}>Launch app</Link>
            </Button>
          </div>
