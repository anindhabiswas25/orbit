...
const securityFeatures = [
  {
    ...
    description: "You always own your USDC — agents never hold it.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Stake always at risk",
    description: "Agents stake USDC and are slashed for misbehavior.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "On-chain audit trail",
    description: "Every job and rebalance is recorded forever.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Engine-only assignment",
    description: "Agents can never assign themselves a job.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Non-custodial", "Atomic", "Auditable", "Permissionless"];
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Agents compete hard, but the protocol holds the keys. Smart-contract invariants ensure they can only ever do what you allow.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Enforced by contract</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">0</span>
                <span className="block text-muted-foreground mt-2">User funds ever lost</span>
              </div>
            </div>
